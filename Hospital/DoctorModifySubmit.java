...
class DoctorModifySubmit extends JFrame implements ActionListener
{
    ...
    DoctorModifySubmit(String x,String name2,String id,String work,String specialist,String qualific)
    {
...
//  add(lworkto);
    ...
    set(name2,work,specialist,qualific);//call to set method
...
public void actionPerformed(ActionEvent ae)
    ...
    {
        //new DoctorModifySubmit("xyz","gangadhar","09","05","sugery");
    }
}
